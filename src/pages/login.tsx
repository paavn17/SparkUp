...
const Login: React.FC = () => {
  ...
  return (
    ...
    <div className=" p-6 rounded-lg shadow-lg h-[400px] w-96 flex flex-col justify-between">
      ...
      <div className="flex gap-2">
        <button onClick={loginUser} className="flex-1 bg-green-500 text-white p-2 rounded hover:bg-green-600">
          Log In
        </button>
      </div>
  ...
  <Link to="/signup" className="text-blue-500 hover:underline">
    Register
      ...
      <button className="w-full bg-white text-black p-2 rounded hover:bg-green-500 hover:text-white flex items-center justify-center gap-2">
